...
#define HIG_SMALL      6        /* mate hig small space in pixels */
#define HIG_LARGE     12        /* mate hig large space in pixels */
...
GtkDialog*
bastile_passphrase_prompt_show (const gchar *title, const gchar *description, 
...
const gchar*
bastile_passphrase_prompt_get (GtkDialog *dialog)
{
...
gboolean
bastile_passphrase_prompt_checked (GtkDialog *dialog)
{
