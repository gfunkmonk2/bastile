/**
 * @file bastile-gtkstock.c GTK+ Stock resources
 *
 * Bastile
 *
...
static const gchar *bastile_icons[] = {
    BASTILE_STOCK_KEY,
    BASTILE_STOCK_SECRET,
    BASTILE_STOCK_KEY_SSH,
    BASTILE_STOCK_PERSON,
    BASTILE_STOCK_SIGN,
    BASTILE_STOCK_SIGN_OK,
    BASTILE_STOCK_SIGN_BAD,
    BASTILE_STOCK_SIGN_UNKNOWN,
    NULL
};

static const gchar *themed_icons[] = {
    BASTILE_THEMED_WEBBROWSER,
    BASTILE_THEMED_FOLDER,
    "emblem-readonly",
    NULL
};
...
bastile_gtkstock_init(void)
{
    ...
    gtk_window_set_default_icon_name ("bastile");
    
    add_icons (bastile_icons, themed_icons);
}

/**
 * bastile_gtkstock_add_icons:
 * @icons: The icons to add to the default factory
 *
 * Adds icons to the factory
 */
void
bastile_gtkstock_add_icons (const gchar **icons)
{
