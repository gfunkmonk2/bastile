...
#ifndef __BASTILE_PREFERENCES_H__
#define __BASTILE_PREFERENCES_H__

#include <gtk/gtk.h>

#define LISTING_SCHEMAS BASTILE_SCHEMAS "/listing"
...
void bastile_preferences_show  (GtkWindow *parent, const gchar *tabid);
