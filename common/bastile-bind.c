...
gpointer 
bastile_bind_property (const gchar *prop_src, gpointer obj_src, 
                        const gchar *prop_dest, gpointer obj_dest)
{
	...
	return bastile_bind_property_full (prop_src, obj_src,
	                                    g_value_transform,
	                                    prop_dest, obj_dest, NULL);
}

gpointer 
bastile_bind_property_full (const gchar *prop_src, gpointer obj_src,
                             BastileTransform transform,
...
gpointer 
bastile_bind_objects (const gchar *property, gpointer object, 
                       BastileTransfer callback, gpointer dest)
{
	GObjectClass *cls;
	Transfer *transfer;
	gchar *detail;
...
void
bastile_bind_disconnect (gpointer what)
{
