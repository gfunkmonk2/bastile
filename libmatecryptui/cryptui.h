...
#ifndef LIBMATECRYPTUI_API_SUBJECT_TO_CHANGE
#error "Please define LIBMATECRYPTUI_API_SUBJECT_TO_CHANGE to acknowledge your understanding that this API is not yet stable."
#endif
 ...
 * the bastile (Passwords and Encryption Keys) application so that they may do so.
 * 
 * quit: whether to run gtk_main_quit () after launching bastile
 */
