...
gpgme_data_t
bastile_gpgme_data_output (GOutputStream* output)
{
	gpgme_error_t gerr;
...
gpgme_data_t
bastile_gpgme_data_input (GInputStream* input)
{
	gpgme_error_t gerr;
	gpgme_data_t ret = NULL;
...
gpgme_data_t
bastile_gpgme_data_new_from_mem (const char *buffer, size_t size, gboolean copy)
{
	gpgme_data_t data;
	gpgme_error_t gerr;
...
int 
bastile_gpgme_data_write_all (gpgme_data_t data, const void* buffer, size_t len)
{
...
void
bastile_gpgme_data_release (gpgme_data_t data)
{
	if (data)
