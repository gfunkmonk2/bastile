...
void bastile_md5_transform(unsigned int buf[4], unsigned int const in[16]);
 ...
 */
void
bastile_md5_init(md5_ctx_t* ctx)
{
 ...
 */
void
bastile_md5_update(md5_ctx_t* ctx, const void* b, unsigned len)
{
    unsigned int t;
    ...
    byteSwap(ctx->in, 16);
    bastile_md5_transform(ctx->buf, ctx->in);
    buf += t;
    len -= t;
 ...
 */
void
bastile_md5_final(unsigned char digest[16], md5_ctx_t* ctx)
{
 ...
 */
void
bastile_md5_transform(unsigned int buf[4], unsigned int const in[16])
{
